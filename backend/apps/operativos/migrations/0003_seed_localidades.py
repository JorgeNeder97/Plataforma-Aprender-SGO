...
def forward(apps, schema_editor):
    ...
    for loc in LOCALIDADES:
        depto_id = loc.pop("departamento")
        
        departamento = Departamento.objects.get(id=depto_id)
        
        Localidad.objects.get_or_create(departamento=departamento, **loc) # el doble asterisco sirve para desempaquetar un diccionario
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('operativos', '0002_seed_departamentos'),
    ]
